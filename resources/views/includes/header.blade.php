<nav class="navbar navbar-top navbar-expand navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-brand">
            <a class="logo" href="https://clongarzon.com/admin/dashboard">
                <i class="logo-svg">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="100%" style="height:42px;width:42px;">
                        <g>
                            <defs>
                                <clipPath id="clip-path-id-viewbox-item-0">
                                    <rect x="0.0" y="0.0" width="2351.85" height="3016.6"></rect>
                                </clipPath>
                            </defs>
        ...
        <div class="navbar navbar-right">
            <button type="button" class="navbar-toggler" data-bs-toggle="collapse" data-bs-target="#navSidebar" aria-controls="navSidebar" aria-expanded="false" aria-label="Toggle navigation">
                <span class="fa fa-bars"></span>
            </button>

            <ul id="menu-mainmenu" class="navbar-nav" data-control="mainmenu" data-alias="mainmenu">
                <li id="menuitem-preview" class="nav-item">
                    <a class="nav-link front-end" href="https://clongarzon.com" target="_blank" aria-label="Витрина" data-bs-original-title="Витрина">
                        <i class="fa fa-store"></i>
                    </a>
                </li>

                <li id="menuitem-activity" class="nav-item dropdown">
                    <a class="nav-link" href="https://clongarzon.com/admin" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                        <i class="fa fa-bell" role="button"></i>
                        <span class="badge badge-danger">&nbsp;</span>
                    </a>

                    <ul class="dropdown-menu " data-request-options="activity">
                        <li class="dropdown-header"> Последние действия </li>
                        ...
                        <li class="dropdown-footer">
                            <a class="text-center" href="https://clongarzon.com/admin/activities"><i class="fa fa-ellipsis-h"></i></a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        <div class="menu menu-grid row">
                            <div class="menu-item col col-4">
                                <a class="menu-link" href="https://clongarzon.com/admin/settings/edit/general">
                                    <i class="fa fa-sliders"></i>
                                    <span>Общие</span>
                                </a>
                            </div>
                            <div class="menu-item col col-4">
                                <a class="menu-link" href="https://clongarzon.com/admin/settings/edit/setup">
                                    <i class="fa fa-file-invoice"></i>
                                    <span>Продажи</span>
                                </a>
                            </div>
                            <div class="menu-item col col-4">
                                <a class="menu-link" href="https://clongarzon.com/admin/settings/edit/site">
                                    <i class="fa fa-globe"></i>
                                    <span>Локализация</span>
                                </a>
                            </div>
                            <div class="menu-item col col-4">
                                <a class="menu-link" href="https://clongarzon.com/admin/settings/edit/user">
                                    <i class="fa fa-user"></i>
                                    <span>Регистрация клиента</span>
                                </a>
                            </div>
                            <div class="menu-item col col-4">
                                <a class="menu-link" href="https://clongarzon.com/admin/settings/edit/mail">
                                    <i class="fa fa-envelope"></i>
                                    <span>Почта</span>
                                </a>
                            </div>
                            <div class="menu-item col col-4">
                                <a class="menu-link" href="https://clongarzon.com/admin/settings/edit/media">
                                    <i class="fa fa-image"></i>
                                    <span>Медиа</span>
                                </a>
                            </div>
                            <div class="menu-item col col-4">
                                <a class="menu-link" href="https://clongarzon.com/admin/settings/edit/tax">
                                    <i class="fa fa-file"></i>
                                    <span>Налог</span>
                                </a>
                            </div>
                            <div class="menu-item col col-4">
                                <a class="menu-link" href="https://clongarzon.com/admin/settings/edit/advanced">
                                    <i class="fa fa-cog"></i>
                                    <span>Продвинутый</span>
                                </a>
                            </div>
                        </div>
                        <a class="dropdown-item border-top text-center alert-warning" href="https://clongarzon.com/admin/updates">1 update(s) available</a>
                        <div class="dropdown-footer">
                            <a class="text-center" href="https://clongarzon.com/admin/settings"><i class="fa fa-ellipsis-h"></i></a>
                        </div>
                    </ul>
                </li>


                <li class="nav-item dropdown" data-control="location-picker">
                    <a class="nav-link" href="" data-bs-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" data-request="mainmenu::onChooseLocation" data-request-data="location: '1'">Калабуса ресторан</a>
                        </li>
                        <li>
                            <a class="dropdown-item" data-request="mainmenu::onChooseLocation" data-request-data="location: '2'">Gaviotos</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link" data-bs-toggle="dropdown">
                        <img class="rounded-circle" src="//www.gravatar.com/avatar/4c26178034ec34b11551bb1701c2d3fe.png?d=mm&amp;s=64">
                    </a>
                    <div class="dropdown-menu">
                        <div class="d-flex flex-column w-100 align-items-center">
                            ...
                            <div class="pb-3 text-center">
                                <div class="text-uppercase">Superadmin</div>
                                <div class="text-muted">Ресторатор</div>
                            </div>
                        </div>
                        <div role="separator" class="dropdown-divider"></div>
                        <a class="dropdown-item " data-bs-toggle="modal" data-bs-target="#editStaffStatusModal" role="button">
                            <i class="fa fa-circle fa-fw text-success"></i><span>Установить статус</span>
                        </a>
                        <a class="dropdown-item " href="https://clongarzon.com/admin/staffs/account">
                            <i class="fa fa-user fa-fw"></i><span>Редактировать детали</span>
                        </a>
                        <a class="dropdown-item text-danger" href="https://clongarzon.com/admin/logout">
                            <i class="fa fa-power-off fa-fw"></i><span>Выйти</span>
                        </a>
                        <div role="separator" class="dropdown-divider"></div>
                        <a class="dropdown-item text-black-50" href="https://tastyigniter.com/support" target="_blank">
                            <i class="fa fa-circle-question fa-fw"></i>Центр помощи        </a>
                        <a class="dropdown-item text-black-50" href="https://tastyigniter.com/docs" target="_blank">
                            <i class="fa fa-book fa-fw"></i>Документация        </a>
                        <a class="dropdown-item text-black-50" href="https://forum.tastyigniter.com" target="_blank">
                            <i class="fa fa-comments fa-fw"></i>Поддержка сообщества        </a>
                    </div>
                </li>
